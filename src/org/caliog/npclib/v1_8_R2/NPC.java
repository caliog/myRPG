...
public class NPC extends org.caliog.npclib.NPC {
	private net.minecraft.server.v1_8_R2.ItemStack[] previousEquipment = { null, null, null, null, null };
	...
	public void updateEquipment() {
		...
		int changes = 0;
		net.minecraft.server.v1_8_R2.ItemStack[] newI = new net.minecraft.server.v1_8_R2.ItemStack[previousEquipment.length];
		for (int i = 0; i < previousEquipment.length; i++) {
			net.minecraft.server.v1_8_R2.ItemStack previous = previousEquipment[i];
			net.minecraft.server.v1_8_R2.ItemStack current = ((EntityPlayer) getEntity()).getEquipment(i);
			newI[i] = current;
			if (current == null) {
				if (previous != null) {
				...
				if (!net.minecraft.server.v1_8_R2.ItemStack.equals(previous, current)
