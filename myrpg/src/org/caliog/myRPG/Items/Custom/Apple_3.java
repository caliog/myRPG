...
public class Apple_3 extends CustomItem {
    public Apple_3(int amount) {
	super(Material.APPLE, "Apple III", true);
	setAmount(amount);
	syncItemStack();
    }
	...
	lore.add(" ");
	lore.add(ChatColor.GOLD + "This apple gives you 20 lifepoints!");
	lore.add(" ");
	if (!isTradeable()) {
