...
public class Util extends NMSUtil {
	...
	if (node.b.getType() != Material.AIR) {
	    ...
	    final AxisAlignedBB box = net.minecraft.server.v1_7_R4.Block.getById(node.b.getTypeId()).a(
		    ((CraftWorld) node.b.getWorld()).getHandle(), node.b.getX(), node.b.getY(), node.b.getZ());
