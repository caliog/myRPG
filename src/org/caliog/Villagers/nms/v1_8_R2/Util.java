package org.caliog.Villagers.nms.v1_8_R2;
...
public class Util implements NMSUtil {
	...
	public static net.minecraft.server.v1_8_R2.Entity getHandle(Entity entity) {
	...
	private net.minecraft.server.v1_8_R2.ItemStack getHandle(ItemStack item) {
		if (item == null)
			return null;
