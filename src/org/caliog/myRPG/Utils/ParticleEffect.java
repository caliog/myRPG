...
import org.caliog.myRPG.Utils.ParticleEffect.ParticleData;
import org.caliog.myRPG.Utils.ReflectionUtils.PackageType;
				...
				if (version < 8) {
					...
					if (data != null) {
						...
						ReflectionUtils.setValue(packet, true, "k",
								effect == ParticleEffect.ITEM_CRACK ? packetData : new int[] { packetData[0] | (packetData[1] << 12) });
					}
				}
